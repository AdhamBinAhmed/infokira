...
export default function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="flex h-8 w-8 items-center justify-center rounded-full border border-line text-ink transition-colors hover:bg-ink hover:text-paper"
    >
      {/* Render nothing decisive until mounted to avoid a wrong-icon flash */}
      {mounted && isDark ? (
        // sun
